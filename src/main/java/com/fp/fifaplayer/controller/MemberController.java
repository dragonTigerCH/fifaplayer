...
public class MemberController {
   ...
   private final AuthenticationManager authenticationManager;
    ...
    public String memberJoin(@Validated @ModelAttribute MemberSaveForm memberSaveForm, BindingResult bindingResult, Model model){
    ...
    //회원가입 인증
    @PostMapping("/auth")
    public String auth(@ModelAttribute MemberSaveForm memberSaveForm, String realNum, String checkNum, Model model, RedirectAttributes redirectAttributes){
        System.out.println(memberSaveForm +"///"+realNum+"///"+checkNum);

        
        if(realNum.equals(checkNum)){
            memberService.save(memberSaveForm);
            redirectAttributes.addFlashAttribute("msg","회원가입이 완료되었습니다.");
            return "redirect:/member/login";
        }else{
            model.addAttribute("num",realNum);
            model.addAttribute("memberSaveForm", memberSaveForm);
